Phantom CSS Based Visual Regression Testing framework
=====================================================

This is a visual regression testing framework based on PhantomCSS. To run, you will need CasperJS installed on your machine.

## Installing CasperJS
[CasperJS](http://docs.casperjs.org/en/latest/installation.html)

For MAC (Only CasperJS v1.1. Older v1.0 doesn't work)
